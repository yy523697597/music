...
/**
 * 
 * @authors 谢志强 (594613537)
 * @date    2016-05-18 01:14:13
 * @version v1.0.0
 */
.github {
  width: 200px;
...
.loader-six div:nth-child(3) {
  -webkit-animation: loader6 0.8s 0s infinite
...
.loader-eight div:nth-child(3) {
  ...
  -webkit-animation: loader8-3 0.5s -0.3s infinite;
}
...
.loader-eight div:nth-child(7) {
  ...
  -webkit-animation: loader8-7 0.5s -0.1s infinite;
}
...
.loader-ten div:nth-child(3) {
  ...
  left: 20px;
  -webkit-transform: rotate(90deg);
  -webkit-animation: loader10 0.5s -0.3s infinite ease-in-out;
}
...
.loader-28 div:nth-child(2n-1) {
  -webkit-animation: loader28-1 1s 0s cubic-bezier(0, 0.79, 0.885, 0.23)
    infinite;
}
.loader-28 div:nth-child(2n) {
  -webkit-animation: loader28-1 1s 0.5s cubic-bezier(0, 0.79, 0.885, 0.23)
    infinite;
}
